...
COPY analyze.py team.py report.py faceit_stats.py artifacts.py cluster_run.py ./
...
RUN python -c "import analyze, report, team, faceit_stats, artifacts, cluster_run"
